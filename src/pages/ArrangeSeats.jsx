...
const ArrangeSeats = () => {
  ...
  const handleArrangeSeats = async () => {
    ...
    try {
      ...
      // Call API to generate seating arrangement with branches
      await generateSeatingArrangement(selectedExam, classroomId, {
        branch1,
        branch2,
      });
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          ...
          <div className="bg-gray-50 p-4 rounded-md border border-gray-200 mb-6">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Choose an exam to create a seating arrangement for this classroom.
            </p>
            ...
            <h2 className="text-lg font-medium mt-6 mb-2">Select Branches</h2>
            ...
            {exams.length === 0 && (
              <p className="text-sm text-amber-700 mt-2">
                No available exams found. All exams may already have classrooms
                assigned.
              </p>
            )}
          </div>
          ...
          <button
            ...
            className="px-4 py-2 bg-gray-900 text-white rounded-md hover:bg-gray-800 text-sm font-medium transition-colors flex items-center justify-center w-full md:w-auto"
            disabled={!selectedExam || !branch1 || !branch2 || arranging}
          >
            {arranging ? (
              <>
